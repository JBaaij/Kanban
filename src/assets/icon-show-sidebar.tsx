...
interface IconShowSidebarProps extends React.SVGProps<SVGSVGElement> {
  // You can add additional custom props here if needed
}

const IconShowSidebar: React.FC<IconShowSidebarProps> = (props) => (
...
export default IconShowSidebar;
